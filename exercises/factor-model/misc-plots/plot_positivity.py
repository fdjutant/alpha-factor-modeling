...
# filename = 'Chip1-Antibody_positivity_report_batch.csv'
# filename = 'Chip2-PS_positivity_report_batch.csv'
# filename = 'Chip2-Antibody_positivity_report_batch.csv'
filename = 'Control-no-EV_positivity_report_batch.csv'
...
plt.savefig(filename[:-4]+'-plot.png', transparent=True)
plt.show()